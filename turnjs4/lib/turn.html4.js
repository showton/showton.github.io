  ...
  var has3d,
    ...
    turnMethods = {
      ...
      init: function (opts) {
        ...
        $(this).bind(mouseEvents.down, data.docEvents.mouseStart).bind('start', turnMethods._start).bind('end', turnMethods._end).bind('pressed', turnMethods._pressed).bind('released', turnMethods._released).bind('flip', turnMethods._flip);

        $(document).bind(mouseEvents.move, data.docEvents.mouseMove).bind(mouseEvents.up, data.docEvents.mouseEnd);
      ...
      center: function (page) {
        ...
        var data = this.data(), size = $(this).turn('size'), left = size.width / (data.zoom * 2) - size.width / 2;
      ...
      destroy: function () {
        ...
        $(document).unbind(mouseEvents.move, data.docEvents.mouseMove).unbind(mouseEvents.up, data.docEvents.mouseEnd);
      ...
      zoom: function (newZoom) {
        ...
        if (typeof(newZoom) == 'number') {
          ...
          var size = $(this).turn('size'), iz = 1 / data.zoom, newWidth = Math.round(size.width * iz * newZoom),
            newHeight = Math.round(size.height * iz * newZoom);

          data.zoom = newZoom;

          $(this).turn('stop').turn('size', newWidth, newHeight).css({marginTop: size.height * iz / 2 - newHeight / 2});
      ...
      _makeFlip: function (page) {
        ...
        if (!data.pages[page] && data.pagePlace[page] == page) {
          var corner, single = data.display == 'single', odd = page % 2;
      ...
      _necessPage: function (page) {
        ...
        var data = this.data(), range = this.turn('range');

        return data.pageObjs[page].hasClass('fixed') || (page >= range[0] && page <= range[1]);
      ...
      stop: function (ignore, animate) {
        ...
        if (this.turn('animating')) {
          var i, opts, page, data = this.data(), pages = data.pageMv;
      ...
      _missing: function (page) {
        ...
        var p, data = this.data(), range = this.turn('range', page), missing = [];
      ...
      _turnPage: function (page, fromMouseAction) {
        ...
        if (data.pages[current]) {
          ...
          if (data.display == 'single') {
            ...
            if (data.direction == 'ltr') {
              data.pages[current].flip('turnPage', (newView[0] > view[0]) ? 'r' : 'l');
            } else {
              data.pages[current].flip('turnPage', (newView[0] > view[0]) ? 'l' : 'r');
            }
      ...
      next: function () {
        ...
        return this.turn('page', turnMethods._view.call(this, this.data().page).pop() + 1);
      ...
      previous: function () {
        ...
        return this.turn('page', turnMethods._view.call(this, this.data().page).shift() - 1);
      ...
      _start: function (e, opts, corner) {
        ...
        if (data.display == 'single' && corner) {
          ...
          if ((corner == 'l' && data.direction == 'ltr') || (corner == 'r' && data.direction == 'rtl')) {
      ...
      _pressed: function (e) {
        ...
        var page, data = $(e.target).data().f, pages = data.opts.turn.data().pages;
      ...
      _released: function (e, point) {
        ...
        if ((new Date()).getTime() - data.time < 200 || outArea) {
          ...
          turnMethods._turnPage.call(turn, data.opts.next, flipMethods._cornerActivated.call(page, point, 1) === false);
      ...
      update: function () {
        ...
        if (data.pageMv.length && data.pageMv[0] !== 0) {
          ...
          var p, fixed, pos = this.turn('calculateZ', data.pageMv), view = this.turn('view', data.tpage);
...
// Methods and properties for the flip page effect
    ...
    flipMethods = {
      ...
      _cAllowed: function () {
        ...
        var data = this.data().f, turnData = data.opts.turn.data(), page = data.opts.page, odd = page % 2;
      ...
      _foldingPage: function (corner) {
        ...
        var data = this.data().f, opts = data.opts;
      ...
      _backGradient: function () {
        ...
        var data = this.data().f, turn = data.opts.turn,
          gradient = data.opts.gradients && (!turn || turn.data().display == 'single' || (data.opts.page != 2 && data.opts.page != turn.data().totalPages - 1));
      ...
      _fold: function (point) {
        ...
        var data = this.data().f, o = flipMethods._c.call(this, point.corner), relX = (o.x) ? o.x - point.x : point.x,
      ...
      _moveFoldingPage: function (bool) {
        ...
        if (bool) {
          ...
          var folding = flipMethods._foldingPage.call(this), turn = data.opts.turn;
